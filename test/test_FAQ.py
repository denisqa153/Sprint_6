...
class TestFAQ:
    ...
    @allure.story('При клике на вопрос открывается ответ')
    @pytest.mark.parametrize("question_num, answer_num, expected_answer", [
    ...
    def test_faq_answers(self, driver, question_num, answer_num, expected_answer):
            main_page = MainPageScooter(driver)

            main_page.click_question(question_num)

            actual_answer = main_page.get_answer_text(answer_num)
